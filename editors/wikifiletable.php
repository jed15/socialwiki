...
class MoodleQuickForm_socialwikifiletable extends HTML_QuickForm_element {
    ...
    function MoodleQuickForm_socialwikifiletable($elementName = null, $elementLabel = null, $attributes = null, $fileinfo = null, $format = null) {
    ...
    function toHtml() {
        ...
        $files = $fs->get_area_files($this->_fileinfo['contextid'], 'mod_socialwiki', 'attachments', $this->_fileinfo['itemid']); //TODO: verify where this is coming from, all params must be validated (skodak)
        ...
        foreach ($files as $file) {
            if (!$file->is_directory()) {
                ...
                $file_url = file_encode_url($CFG->wwwroot.'/pluginfile.php', "/{$this->_contextid}/mod_socialwiki/attachments/{$this->_fileareaitemid}/".$file->get_filename());
...
//register wikieditor
MoodleQuickForm::registerElementType('socialwikifiletable', $CFG->dirroot."/mod/socialwiki/editors/wikifiletable.php", 'MoodleQuickForm_socialwikifiletable');
