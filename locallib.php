 ...
 */
function socialwiki_get_follows($userid){
	global $DB;
	$sql='SELECT usertoid 
 ...
 */
function socialwiki_is_following($userfromid,$usertoid)
{
	Global $DB;
	$sql='SELECT usertoid 
		  FROM {socialwiki_follows}
	...
	return $DB->record_exists_sql($sql,array($userfromid,$usertoid));
}

function socialwiki_unfollow($userfromid,$usertoid){
	Global $DB;
