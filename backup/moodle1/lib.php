 ...
 */
class moodle1_mod_socialwiki_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'socialwiki', '/MOODLE_BACKUP/COURSE/MODULES/MOD/SOCIAL_WIKI',
                array(
                    'newfields' => array(
                        'introformat' => '0',
     ...
     * data available
     */
    public function process_socialwiki($data) {
    ...
    public function process_socialwiki_entry($data) {
    ...
    public function on_socialwiki_entry_end() {
        $this->xmlwriter->end_tag('subwiki');
    }

    public function on_socialwiki_pages_start() {
        $this->xmlwriter->begin_tag('pages');
    }

    public function on_socialwiki_pages_end() {
